        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.categories.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="search" class="mar2 form-control" placeholder="@lang('site.search')" value="{{ request()->search }}">
                            </div>
                ...
                <div class="box-body">
                    ...
                    @if ($categories->count() > 0)
                        ...
                        @foreach($categories as $index => $category)
                            <tr>
                                ...
                                <td><a href="{{route('dashboard.products.index' , ['category_id' => $category->id])}}" class="btn btn-primary btn-sm">@lang('site.related_product')</a></td>
                                <td>
                    ...
                    @else
                        <h2 class="text-center">@lang('site.no_categories_found')</h2>
                    @endif
...
{{--                        <h2>@lang('site.no_categories_found')</h2>--}}
