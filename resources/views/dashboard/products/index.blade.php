        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title text-center" style="margin-bottom: 15px ; ">@lang('site.products') <small>{{ $products->total() }}</small></h3>
                ...
                <div class="box-body">
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td><img src="{{ $product->image_path }}" style="width: 100px; height: 50px"  class="img-thumbnail" alt=""></td>
                    ...
                    @else
                        ...
                        <h2 class="text-center">@lang('site.no_products_found')</h2>
